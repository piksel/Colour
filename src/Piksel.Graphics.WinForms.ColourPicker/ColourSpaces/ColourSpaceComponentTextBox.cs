...
namespace Piksel.Graphics.ColourPicker.Controls
{
    ...
    internal class ColourSpaceComponentTextBox : TextBox
    {
        ...
        internal ColourSpaceComponentTextBox() : base()
        {
            this.MaxLength = 3;
        }
        ...
        protected override bool IsInputChar(char charCode)
        {
            ...
            if ((controlModifierKey != Keys.Shift &&
                 ...
                 charCode == (int)Keys.Back || charCode == (int)Keys.Delete))
            {
